...
return [
    ...
    | версий, например, правила размера. Вы можете настроить каждое сообщение.
    |
    */

    'accepted' => 'Вы должны принять поле :attribute.',
    'accepted_if' => 'Вы должны принять поле :attribute, когда :other равно :value.',
    ...
    | используя формат "атрибут.правило" для именования строк. Это позволяет
    ...
    */
    ...
    'custom' => [
        'start_date' => [
            'required' => 'Пожалуйста, укажите дату начала аренды.',
            'date' => 'Дата начала должна быть корректной датой.',
        ],
        'end_date' => [
            'required' => 'Пожалуйста, укажите дату окончания аренды.',
            'date' => 'Дата окончания должна быть корректной датой.',
            'after_or_equal' => 'Дата окончания аренды должна быть позже или равна дате начала.',
        ],
        'comment' => [
            'string' => 'Комментарий должен быть текстом.',
        ],
        'container_id' => [
            'required' => 'Не выбран контейнер для бронирования.',
            'exists' => 'Выбранный контейнер не существует.',
        ],
    ],
    ...
    | на более читаемое название, например "Email-адрес" вместо "email".
    |
    */
    ...
    'attributes' => [
        ...
        'area' => 'площадь',
        'volume' => 'объём',
        'floor_or_location' => 'этаж/расположение',
