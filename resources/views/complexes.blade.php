@extends('layouts.app')
    @section('content')
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-[80px]">
            ...
            <div class="bg-white rounded-[20px] shadow-[5px_5px_15px_-5px_#71C2FF] flex flex-row mb-[100px] transition duration-150 hover:border-[#179BFF]/80 hover:shadow-[7px_7px_25px_-5px_#71C2FF]">
                ...
                <div class="pl-[40px] pr-[120px] py-[20px] flex flex-col justify-between">
                    <div>
                        <h4 class="text-[22px]">Комплекс "{{  $elem -> title  }}"</h4>
