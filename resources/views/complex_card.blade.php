...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-[40px] sm:pt-[60px] lg:pt-[80px]">
    <div>
        <img class="rounded-[20px] sm:rounded-[25px] lg:rounded-[35px] border-[1px] border-[#179BFF]/50 shadow-[5px_5px_15px_-5px_#71C2FF] w-full h-[200px] sm:h-[280px] lg:h-[350px] object-cover" src="{{ asset($complex->image) }}" alt="{{ $complex->title }}">
    </div>
</div>
