                ...
                <div class="flex flex-row flex-wrap justify-between mt-[20px]">
                    ...
                    <div class="bg-[#F3F4F6] rounded-[15px] max-w-[350px] border border-[#595959]/10 shadow-[4px_4px_10px_-5px_#71C2FF]">
                        ...
                        <div class="p-[20px] flex flex-col items-start">
                            ...
                            <a class="w-full" href="{{ route('container_card', $pere->id) }}"><button class="py-2.5 text-white text-2xl w-full bg-[#71C2FF] rounded-lg transition duration-150 hover:bg-[#179BFF] flex flex-row items-center justify-center transition duration-150 hover:bg-[#179BFF] group" type="button"><div class="ml-[70px]">Подробнее</div>
