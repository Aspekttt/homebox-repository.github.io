                ...
                <form action="{{ route('admin.containers.store') }}" method="POST">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div class="mb-4 col-span-2">
                            ...
                            <input type="text" name="image" required placeholder="img/container_1.jpg" class="w-full px-3 py-2 border border-gray-300 rounded-[10px] focus:outline-none focus:border-[#179BFF]">
                        </div>
                    </div>
